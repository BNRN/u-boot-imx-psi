...
#define I2C_PAD_CTRL	(PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_LOW | \
			PAD_CTL_DSE_120ohm | PAD_CTL_HYS | \
...
static iomux_v3_cfg_t const ecspi_pads[] = {
	MX6_PAD_KEY_ROW1__GPIO4_IO09  | MUX_PAD_CTRL(SPI_PAD_CTRL), /* CS0 */
	MX6_PAD_KEY_COL2__GPIO4_IO10  | MUX_PAD_CTRL(SPI_PAD_CTRL), /* CS1 */
...
static iomux_v3_cfg_t const gpio_pads[] = {
    ...
    // DOUT
        MX6_PAD_DISP0_DAT14__GPIO5_IO08  | MUX_PAD_CTRL(SPI_PAD_CTRL),
        MX6_PAD_DISP0_DAT15__GPIO5_IO09  | MUX_PAD_CTRL(SPI_PAD_CTRL),
        MX6_PAD_DISP0_DAT16__GPIO5_IO10  | MUX_PAD_CTRL(SPI_PAD_CTRL),
        MX6_PAD_DISP0_DAT17__GPIO5_IO11  | MUX_PAD_CTRL(SPI_PAD_CTRL),
